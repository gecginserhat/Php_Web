...
<div class="body">
    <header id="header" class="header-no-border-bottom"
        ...
        <div class="header-body">
                ...
                <div class="header-row">
                    <div class="header-column">
                        <div class="header-logo">
                            <a href="index.php">
                                <img alt="<?php echo $ayarcek['ayar_title']; ?> logosu" width="200" 
                        ...
                        <ul class="header-extra-info">
                            <li>
                                <div class="feature-box feature-box-call feature-box-style-2">
                                    <div class="feature-box-icon">
                                        <i style="color: #2A3F54;" class="icon-call-end icons"></i>
                                    </div>
                            ...
                            <li class="hidden-xs">
                                <div class="feature-box feature-box-mail feature-box-style-2">
                                    <div class="feature-box-icon">
                                        <i style="color: #2A3F54;" class="icon-envelope icons"></i>
                                    </div>
                                    <div class="feature-box-info">
                                        <h4 class="mb-none"><a
            ...
            <div style="background-color: #2A3F54 !important;" class="header-container header-nav header-nav-bar header-nav-bar-primary">
                <div class="container">
                    <button style="color: white !important  ; background-color: #2A3F54 !important  ;" class="btn header-btn-collapse-nav" data-toggle="collapse"
                    ...
                    <div  
                        ...
                        <nav >
                            <ul style=" color:  white  !important    ;" class="nav nav-pills" id="mainNav">
                                <?php
